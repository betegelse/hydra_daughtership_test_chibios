...
CSRC =  $(ALLCSRC) \
        hydra_daughtership/hydra.c hydra_daughtership/message_manager.c \
        hydra_daughtership/sm_manager.c hydra_daughtership/sm_rocket_actions.c \
        hydra_daughtership/sm_rocket_core.c hydra_daughtership/sm_rocket_events.c \
        hydra_daughtership_chibios/event_chibios.c \
	hydra_daughtership_chibios/hydra_priv_chibios.c \
	hydra_daughtership_chibios/radio_chibios.c \
        hydra_daughtership_chibios/sem_manager_chibios.c \
	hydra_daughtership_chibios/timer_manager_chibios.c \
        main.c
...
# Header files here.
INCDIR =  $(ALLINC) \
	hydra_daughtership_chibios hydra_daughtership
